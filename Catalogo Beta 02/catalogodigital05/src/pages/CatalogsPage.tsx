...
import {Plus, Search, Filter, Edit, Trash2, Eye, Share, QrCode, MessageCircleDashed as MessageCircle, Copy, Check} from 'lucide-react'
            ...
            <div className="p-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  >
                    {copiedLink === catalog._id ? <Check size={16} /> : <Copy size={16} />}
                  </button>
                  <button
