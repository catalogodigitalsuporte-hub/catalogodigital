...
const Dashboard: React.FC = () => {
    ...
    const { resellers, loading: resellersLoading, error: resellersError } = useResellers()
  ...
  const hasError = resellersError || productsError || analyticsError
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px] bg-red-50 border border-red-200 rounded-lg p-8">
        <div className="text-center">
          ...
          <p className="text-red-700">Ocorreu uma falha ao tentar carregar o Dashboard.</p>
          <p className="text-red-700 text-sm mt-1">Detalhes: {resellersError || productsError || analyticsError}</p>
          <p className="text-red-700 text-sm mt-3">Por favor, verifique sua conexão com a API Lumi e tente novamente.</p>
        </div>
      </div>
    )
  }
  ...
  const totalSales = resellers?.reduce((sum, r) => sum + (r.total_sales || 0), 0) || 0
  const totalOrders = resellers?.reduce((sum, r) => sum + (r.total_orders || 0), 0) || 0
          ...
          <div className="p-6">
            {recentResellers.length === 0 ? (
              <div className="text-center py-8">
                <LucideIcons.Users className="w-12 h-12 text-gray-300 mx-auto mb-4" />
              ...
              <div className="space-y-4">
                {recentResellers.map((reseller) => (
                  <div key={reseller._id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200">
          ...
          <div className="p-6">
            <div className="space-y-4">
              ...
              <div className="text-center py-8">
                <LucideIcons.Activity className="w-12 h-12 text-gray-300 mx-auto mb-4" />
