      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              ...
              <LucideIcons.BookOpen className="w-8 h-8 text-blue-600" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              ...
              <LucideIcons.Package className="w-8 h-8 text-green-600" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              ...
              <LucideIcons.Eye className="w-8 h-8 text-purple-600" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              ...
              <LucideIcons.Share2 className="w-8 h-8 text-orange-600" />
            </div>
          </div>
        </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex space-x-2">
                        <button
                          ...
                          title="Copiar link"
                        >
                          {copiedLink === catalog.catalog_id ? <LucideIcons.Check size={16} /> : <LucideIcons.Copy size={16} />}
                        </button>
        ...
        {!catalogsLoading && catalogs.length === 0 && (
          <div className="text-center py-12">
            <LucideIcons.BookOpen className="w-16 h-16 text-gray-400 mx-auto mb-4" />
