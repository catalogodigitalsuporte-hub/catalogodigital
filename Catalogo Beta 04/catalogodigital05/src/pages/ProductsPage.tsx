                        ...
                        <div className="flex-shrink-0 h-12 w-12">
                          {product.images?.[0] ? (
                            ...
                            <div className="h-12 w-12 bg-gray-200 rounded-lg flex items-center justify-center">
                              <LucideIcons.Image className="h-6 w-6 text-gray-400" />
                            </div>
                          )}
                        </div>
                        <div className="ml-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      <LucideIcons.DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={16} />
                      <input
                        type="number"
                        step="0.01"
                        min="0"
