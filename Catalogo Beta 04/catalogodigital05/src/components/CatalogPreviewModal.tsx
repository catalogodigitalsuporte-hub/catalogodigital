        ...
        <div className="w-80 h-[700px] bg-gray-900 rounded-3xl p-3 shadow-2xl">
          ...
          <div className="w-full h-[calc(100%-24px)] bg-white rounded-b-2xl overflow-hidden">
            ...
            >
              ...
              >
                <div className="relative">
                  <LucideIcons.ShoppingCart size={20} className="text-white" />
                  {cartItemsCount > 0 && (
            ...
            <div className="p-6">
              {cart.length === 0 ? (
                <div className="text-center py-8">
                  <LucideIcons.ShoppingCart className="w-16 h-16 text-gray-400 mx-auto mb-4" />
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-4 flex items-center">
                  <LucideIcons.User size={20} className="mr-2" />
                  Dados Pessoais
                </h3>
                <div className="space-y-4">
                  <input
              ...
              <div>
                <h3 className="text-lg font-semibold mb-4 flex items-center">
                  <LucideIcons.MapPin size={20} className="mr-2" />
                  Endereço de Entrega
                </h3>
                <div className="space-y-4">
