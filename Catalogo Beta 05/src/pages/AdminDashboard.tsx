...
import {Users, TrendingUp, ShoppingBag, DollarSign, Plus, UserPlus, BarChart3, Settings, Crown, AlertCircle} from 'lucide-react'
          ...
          {!isRealAdmin && (
            <div className="text-center">
              <div className="bg-red-500/20 border border-red-300 rounded-lg p-4 mb-4">
                <AlertCircle className="w-6 h-6 mx-auto mb-2 text-red-200" />
